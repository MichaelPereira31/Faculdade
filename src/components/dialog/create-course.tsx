...
import { createCourse } from "@/actions/course/create/create-course";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  const saveCourse = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast.error(response.error || "Erro ao criar curso");
      }
    } catch {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha os detalhes do curso abaixo. Todos os campos são
            obrigatórios.
          </DialogDescription>
        </DialogHeader>
